...
<body class="bg-dark text-light">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card bg-dark text-light shadow-lg border-light">
                    <div class="card-body">
                        ...
                        <hr class="my-4">
                        <p class="text-center">Belum punya akun? <a href="register.php" class="text-primary">Daftar disini!</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Footer -->
    <footer class="d-flex justify-content-center align-items-center bg-dark text-white py-3 mt-4">
